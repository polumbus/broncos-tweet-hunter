...
if tweets:
st.success(f"✅ Found {len(tweets)} viral debates!")
...
st.image(media.preview_image_url, caption="Video (click Twitter link to watch)", use_container_width=True)
except Exception as e:
st.write(f"Could not load media")
